...
const SectionTitle = ({
  ...
  return (
    <motion.div
      ...
      className={`flex flex-col mb-12 max-w-3xl ${align === 'center' ? 'mx-auto' : ''} ${alignClasses[align]}`}
    >
      {subtitle && (
      ...
      <div className="w-16 h-1 bg-gradient-to-r from-primary-500 to-teal-500 rounded-full mb-4" />
      {description && (
